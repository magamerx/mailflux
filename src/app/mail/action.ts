...
export async function generateEmail(context: string, prompt: string) {
  ...
  const data = `You are an AI email assistant embedded in an email client app. Your purpose is to help the user compose emails by providing suggestions and relevant information based on the context of their previous emails.
